...
class TestZJIT < Test::Unit::TestCase
  ...
  def test_virtual_string_slice_dump_hir
    ...
    assert_includes(test_hir, "rb_jit_vstr_strip_beg")
    assert_includes(test_hir, "rb_jit_vstr_strip_end_from")
    assert_includes(test_hir, "rb_jit_vstr_delete_prefix_len")
    ...
    refute_includes(test_hir, "rb_jit_vstr_measure0")
    refute_includes(test_hir, "rb_jit_vstr_measure1")
