...
unsafe extern "C" {
    ...
    pub fn rb_jit_vstr_copy(out: *mut c_void, slice: *const c_void) -> *mut c_void;
    ...
    pub fn rb_jit_vstr_empty_p(slice: *const c_void) -> VALUE;
    pub fn rb_jit_vstr_bytesize(slice: *const c_void) -> VALUE;
